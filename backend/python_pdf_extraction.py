...
def main():
    ...
    local_pdf_path = download_file_from_s3(
        input_pdf_s3_key, str(local_base_dir), bucket_name=s3_bucket
    )
    ...
    markdown_local_path = (
        output_dir / f"{Path(local_pdf_path).stem}_extracted_output.md"
    )
